...
\documentclass[smallcondensed,final,natbib]{svjour3}          % twocolumn
%
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[ width=174mm]{Fig1}
...
\bibitem[{Anderson(2003)}]{andersonMultivariate}
...
\bibitem[{Fan et~al.(2007)Fan, Hall and Yao}]{fan2007to}
...
\bibitem[{Romano(1990)}]{Romano1990On}
...
\bibitem[{Subramanian et~al.(2005)Subramanian, Tamayo, Mootha, Mukherjee,
...
\bibitem[{Wang et~al.(2015)Wang, Peng and Li}]{Wang2015A}
