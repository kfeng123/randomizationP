...
\begin{theorem}
    Under the condition of Theorem~\ref{shaziCLT}, we have 
    \begin{equation*}
...
\begin{remark}
    The theorem doesn't assume the distribution of $X_i$ is symmetric. Hence randomization test is robust in this mean.
\end{remark}
