...
\begin{theorem}\label{ourTheorem}
    ...
    \begin{enumerate}[(i)]
        \item
            ...
            $;
\item
    if $\sqrt{\mytr(\Sigma^2)}=o\big(\mu^T \mu\big)$, $q_{\alpha}^*$ converges in probability to the $1-\alpha$ quantile of  $(\chi^2_1-1)/\sqrt{2}$, the centralized chi-squared distribution with degree of freedom $1$.
    \end{enumerate}
\end{theorem}
