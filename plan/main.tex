...
\footnotesize
    ...
    \begin{tabular}{cccccccccccccc}
          ...
          \cmidrule(r){3-5}  \cmidrule(r){6-8} \cmidrule(r){9-11}  \cmidrule(r){12-14}
           $(n,p)$&SNR & RM & AM & BM & RM & AM & BM & RM & AM & BM & RM & AM & BM  \\ 
            \midrule
        $(100,600)$ &0.0 (size) & 0.05 & 0.044 & 0.051 & 0.053 & 0.074 & 0.050 & 0.058 & 0.051 & 0.071 \\ 
% new simulations
        %\midrule
        %200&1000&0.0 (size) & 0.050 & 0.0505 & 0.0550 & 0.0505 & 0.0695 & 0.0520 & 0.0575 & 0.0510 & 0.0700 \\ 
          %&&0.5 & 0.126 & 0.1885 & 0.2025 & 0.1410 & 0.1680 & 0.1745 & 0.1865 & 0.0855 & 0.1165 \\ 
...
\end{table*}
\begin{table*}[ht]
    \caption{Empirical power and size of compound symmetry structure innovation.  TP is the theoretical asymptotic power, RM represents the randomization method, AM represents the asymptotic method.}
\label{table4}
\footnotesize
    \centering
    \begin{tabular}{clcccccccccccc}
