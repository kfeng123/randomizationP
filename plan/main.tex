...
$$
    To calculate the variance of $\sum_{j<i} Y_{ij}^2$, we consider $\myE \big(\sum_{j<i}Y_{ij}^2\big)^2$.
...
\sum_{i=1}^n b_i^2=\|t\|^2+o_P(1).
    ...
    \begin{equation*}
    \begin{aligned}
        &\myE\sum_{j<k}\big(\sum_{i:i>k} a_{ij} a_{ik}\big)^2
        =
        \myE\sum_{j<k}\Big(\sum_{i:i>k}a_{ij}^2 a_{ik}^2
        +2\sum_{i_1,i_2:i_1>i_2>k} a_{i_1 j} a_{i_1 k} a_{i_2 j} a_{i_2 k}\Big)\\
        =&
        \myE\sum_{j<k<i}a_{ij}^2 a_{ik}^2
        +2\myE\sum_{j<k<i_2<i_1}a_{i_1 j} a_{i_1 k} a_{i_2 j} a_{i_2 k}.\\
    \end{aligned}
    \end{equation*}
